...
const home_jpg_1 = __importDefault(require("../../public/home.jpg"));
require("./home.css");
function Home() {
    (0, react_1.useEffect)(() => {
    ...
    const values = [
        {
            icon: <fi_1.FiAward />,
            title: 'Excellence',
            description: 'We uphold the highest standards in all our training, mentorship, and support services.',
        },
        {
            icon: <fi_1.FiUsers />,
            title: 'Community',
            description: 'We foster a strong sisterhood where women uplift each other and grow together.',
        },
        {
            icon: <fi_1.FiTarget />,
            title: 'Accessibility',
            description: 'Our programs are designed to be inclusive, affordable, and easily accessible to all women.',
        },
    ];
    return (<div className="home-page">
      {/* Hero Section */}
      <section className="hero">
        <image_1.default src={home_jpg_1.default} alt="Empowered woman with laptop" className="hero-image" priority/>
        <div className="hero-overlay">
          <div className="hero-content" data-aos="fade-up">
            ...
            <div className="hero-buttons">
              <link_1.default href="/mentorship">
                <button className="btn-primary">Find a Mentor</button>
              </link_1.default>
              <link_1.default href="/services/courses">
      ...
      <section className="features-section" data-aos="fade-up">
        <div className="feature-card">
          <fa_1.FaChalkboardTeacher className="feature-icon"/>
        ...
        <div className="feature-card">
          <fa_1.FaHandHoldingHeart className="feature-icon"/>
          <h3>Mentorship</h3>
          <p>
        ...
        <div className="feature-card">
          <fa_1.FaShoppingBasket className="feature-icon"/>
      ...
      <section className="section values" data-aos="fade-up">
        ...
        <div className="values-cards">
          {values.map(({ icon, title, description }) => (<div key={title} className="value-card" data-aos="zoom-in">
      ...
      <section className="our-process-section" data-aos="fade-up">
        ...
        ].map((item, index) => (<div className={`timeline-item ${index % 2 === 0 ? 'left' : 'right'}`} data-aos="fade-up" key={item.title}>
              <h3>{item.title}</h3>
              <p>{item.desc}</p>
              <ul>
