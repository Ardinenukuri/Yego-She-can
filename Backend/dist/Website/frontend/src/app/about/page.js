...
const _2148761757_jpg_1 = __importDefault(require("../../../public/2148761757.jpg"));
...
function About() {
    ...
    const values = [
        {
            icon: <fi_1.FiAward />,
            title: 'Excellence',
            description: ' We maintain the highest standards in our curriculum, instruction, and support services.',
        },
        {
            icon: <fi_1.FiUsers />,
            title: 'Community',
            description: ' We foster a supportive environment where women lift each other up and celebrate shared success.',
        },
        {
            icon: <fi_1.FiTarget />,
            title: 'Accessibility',
            description: 'We remove barriers to education by making our programs affordable and accessible to all.',
        },
    ];
    return (<div className="about-container">
      <section className="hero-section" data-aos="fade-up">
        <div className="hero-image-wrapper">
          <image_1.default src={_2148761757_jpg_1.default} alt="Empowering Women" fill priority style={{ objectFit: 'cover' }}/>
    ...
    <div className="cards">
      <section className="card-section" data-aos="fade-up">
        <div className="info-card">
          <div className="card-icon">
            <fa_1.FaBullseye /> <h2>Our Mission</h2>
          </div>
      ...
      <section className="card-section" data-aos="fade-right">
        <div className="info-cards">
          <div className="card-icon">
            <fa_2.FaUsers />  <h2>Who We Serve</h2>
          </div>
        ...
        <div className="info-cards" data-aos="fade-left">
          <div className="card-icon">
            <fa_2.FaHeart />  <h2>Why We Focus on Women 30-</h2>
          </div>
          <ul className="card-list">
  ...
  <div className="story-container">
    ...
    <div className="story-content">
      ...
      <div className="values-cards">
        {values.map(({ icon, title, description }) => (<div key={title} className="value-card">
  ...
  <div className="team-grid">
    {[
        ...
        ].map((member, index) => (<div key={index} className="team-card">
