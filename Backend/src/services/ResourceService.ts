...
export const ResourceService = {
    addCourseResource: async (
        mentorId: number, 
        courseId: number, 
        data: { description: string, timeline: string, level: 'beginner' | 'intermediate' | 'advanced' },
        ...
        try {
            ...
            const resourceInsertQuery = `
                INSERT INTO resources (course_id, mentor_id, description, timeline, level, file_path, image_url, original_filename)
